...
int main(void){
    ...
    FILE* fp=fopen("/Users/justinkim/Desktop/Seneca/semester5/DSA555/a3/a3/a3/dictionary.txt","r");
    FILE* fp2;
    FILE* fp3;
    ...
    fp=fopen("/Users/justinkim/Desktop/Seneca/semester5/DSA555/a3/a3/a3/suggestions.txt","r");
    for(int i=0;i<11;i++){
    ...
    cout << "Time for lookups: " << lookupTimer.currtime() << endl;
    ...
    if(notfound!=0){
        ...
        if(!(feof(fp2)&&feof(fp3)) || error){
            ...
            cout << "Time for lookups: " << lookupTimer.currtime() << endl;
            cout << "Time for suggestions: " << suggestionTimer.currtime() << endl;
        }
        fclose(fp2);
        fclose(fp3);
    }
